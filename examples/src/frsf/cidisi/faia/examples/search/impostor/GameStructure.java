...
public class GameStructure {
  ...
  // Game data structure
  public static final int[][] SHIP = new int[20][4];
  public static final int[] AGENT_ORIENTATION = new int[4];
  public static final int[] CREW_PER_ROOM = new int[20];
  ...
  public static final int[] INITIAL_CREW_POSITION = new int[20];
  ...
  public void init() {
    ...
    // Medbay = 13
    SHIP[ROOM_ELECTRICAL][UP] = HALL_E;
    SHIP[ROOM_ELECTRICAL][DOWN] = WALL;
    SHIP[ROOM_ELECTRICAL][LEFT] = WALL;
    SHIP[ROOM_ELECTRICAL][RIGHT] = WALL;
